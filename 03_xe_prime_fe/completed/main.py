...
outer_hex = openmc.model.HexagonalPrism(
    edge_length=1.91516 / np.sqrt(3), orientation="x"
)
outer_hex.boundary_type = "reflective"
top = openmc.ZPlane(129.54 / 2)
top.boundary_type = "vacuum"
bottom = openmc.ZPlane(-129.54 / 2)
...
mesh.lower_left = (-1.91516 / np.sqrt(3), -1.91516 / np.sqrt(3), -129.54 / 2)
mesh.upper_right = (1.91516 / np.sqrt(3), 1.91516 / np.sqrt(3), 129.54 / 2)
mesh.dimension = (5, 5, 40)
...
settings.temperature = {"method": "interpolation", "tolerance": 500}
